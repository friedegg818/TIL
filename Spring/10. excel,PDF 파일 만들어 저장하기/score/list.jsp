...
<tr height="35">
	...
	<td align="right">
		...
		<button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/score/excel';">Excel 다운로드</button>
		<button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/score/pdf';">PDF 다운로드</button>
	</td>
</tr>
</table>
...
<tr height="35" bgcolor="#ffffff" align="center">
	...
	<input type="hidden" name="page" value="${page}">		<!-- 리스트 삭제시 페이지 받게 하므로 -->
</form>
