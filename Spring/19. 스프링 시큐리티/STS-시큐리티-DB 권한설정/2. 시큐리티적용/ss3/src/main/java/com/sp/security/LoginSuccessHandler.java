...
*  - 로그인 전 정보를 Cache : 로그인 되지 않은 상태에서 로그인 상태에서만 사용할 수 있는 페이지로
*    이동할 경우 로그인 페이지로 이동하고 로그인 후 로그인 전 페이지로 이동
*/
...
public class LoginSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest req,
		...
		Member member=memberService.readMember2(authentication.getName());
