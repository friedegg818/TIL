    ...
    <ul class="nav">
        ...
        <li>
            ...
            <ul>
                ...
                <li><a href="#">자료실</a></li>
                <li><a href="${pageContext.request.contextPath}/photo/list">포토갤러리</a></li>
        ...
        <li>
            <a href="#">고객센터</a>
            <ul>
                <li><a href="${pageContext.request.contextPath}/faq/main">자주하는질문</a></li>
                <li><a href="${pageContext.request.contextPath}/customer/notice">공지사항</a></li>
                <li><a href="${pageContext.request.contextPath}/customer/inquiry">1:1문의</a></li>
                <li><a href="${pageContext.request.contextPath}/customer/qna">질문과답변</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li><a href="#">친구관리</a></li>
                <li><a href="#">사진첩</a></li>
                <li><a href="<%=cp%>/mail/send">이메일</a></li>
            </ul>
        </li>
        </c:if>
