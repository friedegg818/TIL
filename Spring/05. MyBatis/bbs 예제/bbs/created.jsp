		...
		<form name="boardForm" method="post">
			<table style="width: 100%; margin-top: 20px; border-spacing: 0; border-collapse: collapse;">
				...
				<tr align="left" height="40" style="border-bottom: 1px solid #cccccc;">
					...
					<td style="padding-left: 10px;">
						<input type="password" name="pwd" size="35" maxlength="7" class="boxTF">&nbsp;(게시물 수정 및 삭제시 필요 !!!)</td>
				</tr>
			</table>
			...
			<table style="width: 100%; border-spacing: 0;">
				<tr height="45">
					<td align="center">
						...
						<button type="button" class="btn" onclick="sendBoard();">${mode == "created" ? "등록완료" : "수정완료"}</button>
